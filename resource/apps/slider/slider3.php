<div class="position-relative u-gradient-half-primary-v5" data-json="slider">
      <!-- Content -->
      <div class="container u-space-4-top u-space-3-bottom position-relative">
        <div class="row">
          <div class="col-md-6 position-relative z-index-2">
            <div class="mb-4">
              <h1 class="display-4 text-white font-weight-normal" data-title>A new standard in analysis</h1>
            </div>
            <div class="mb-7 text-white" data-description>
