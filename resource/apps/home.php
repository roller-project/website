<div class="u-space-3-top u-space-0--lg position-relative"  data-json="slider">
      <div class="d-lg-flex align-items-lg-center min-height-100vh--lg position-relative">
        ...
        <!-- Sidebar -->
        <div class="col-lg-4 u-bg-img-hero min-height-100vh--lg position-absolute-top-right-0--lg px-lg-0 u-space-2" style="background-image: url(<?php echo store_url("uploads/bg1.jpg");?>);">
          <!-- Fancybox -->
...
<div class="bg-primary u-devices-v2">
      <div class="container u-space-3 position-relative z-index-2">
        ...
        <div class="w-md-80 w-lg-50 text-center mx-auto">
          ...
          <p class="lead u-text-light mb-0">Các mốc phát triển dự án của chúng tôi đặt ra để phát triển dự án.</p>
        </div>
        <!-- End Title -->
      </div>
