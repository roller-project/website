  ...
  <head>
    ...
    <body>
      ...
      <div class="container u-space-4-top u-space-3-bottom position-relative">
        <div class="row">
          <div class="col-md-6 position-relative z-index-2">
            <div class="mb-4">
              <h1 class="display-4 text-white font-weight-normal">Roller Flatform</h1>
            </div>
            <div class="mb-7">
              <p class="lead text-white">
                Hệ thống đưa vào vận hành chính thức. <br>
                Từ ngày 12/07/2018 - 20/07/2018 chúng tôi sẽ nhận phần góp vốn của các bạn.<br>
                
                Vốn này dùng để lên sàn sau này.<br>
                Hình thức Mining.  Từ block 1- block 50.000 anh em đã góp cổ phần sẽ ưu tiên đào trước. Anh em tải phần mềm về. Kết nối đến ví của mình và tiến hành đào ROL.<br>
                Lợi nhuận sẽ được chia điều trên các ví không tính số lượng hash kết nối<br>
                Số tài khoản tối đa 35 tài khoản
                <div style="position: relative;">
                  <img src="https://blockchain.info/qr?data=18UDydoLS6eckX2aspZLWUWngKkZahWPkK&size=200" style="float: left;">
                      <div style="margin-left: 210px;">
                        <h4>Đã nhận được 0.61 BTC từ thành viên</h4>
                      Các thành viên tham gia góp tối thiểu 0.2 BTC về ví
                      18UDydoLS6eckX2aspZLWUWngKkZahWPkK.
                      <a class="btn btn-sm btn-danger" href="https://www.blockchain.com/btc/address/18UDydoLS6eckX2aspZLWUWngKkZahWPkK" target="_bank">Xem Blockchaign</a>
                      </div>
                </div>
        ...
        <div class="u-devices-v1__tablet">
          <figure class="u-devices-v1__tablet-svg">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 603 892" style="enable-background:new 0 0 603 892;" xml:space="preserve">
              <path class="u-fill-white" d="M603,51.8v788.5c0,28.5-23.3,51.8-51.8,51.8H51.8C23.3,892,0,868.7,0,840.2L0,51.8C0,23.3,23.3,0,51.8,0l499.5,0C579.7,0,603,23.3,603,51.8z"></path>
              <circle class="u-fill-gray-75" cx="302.5" cy="846.5" r="25.5"></circle>
              <circle class="u-fill-gray-75" cx="301.8" cy="45.9" r="6.2"></circle>
              <g>
                <defs>
      ...
      <figure class="w-25 position-absolute-top-left-0">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 192.5 192.5" style="enable-background:new 0 0 192.5 192.5;" xml:space="preserve">
          <path class="u-fill-warning-darker" d="M0.5,69.5c0.2,0,0.3,0,0.5,0c37.8,0,68.5-30.7,68.5-68.5c0-0.2,0-0.3,0-0.5h-69V69.5z"></path>
          <path class="u-fill-none u-fill-warning-darker" opacity=".55" d="M0.5,100c0.2,0,0.5,0,0.7,0C55.8,100,100,55.8,100,1.2c0-0.2,0-0.5,0-0.7H0.5V100z"></path>
          <path class="u-fill-none u-fill-warning-darker" opacity=".45" d="M0.5,141c0.3,0,0.7,0,1,0C78.6,141,141,78.6,141,1.5c0-0.3,0-0.7,0-1H0.5V141z"></path>
          <path class="u-fill-none u-fill-warning-darker" opacity=".35" d="M0.5,192c0.5,0,0.9,0,1.4,0C106.9,192,192,106.9,192,1.9c0-0.5,0-0.9,0-1.4H0.5V192z"></path>
        </svg>
      </figure>
      <!-- End SVG Shapes v4 -->
    </div>
